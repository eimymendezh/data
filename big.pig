REGISTER '/data/elephant-bird-hadoop-compat-4.1.jar';

REGISTER '/data/elephant-bird-pig-4.1.jar';

REGISTER '/data/json-simple-1.1.1.jar';

w = LOAD '/tweets/' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') AS myMap;
